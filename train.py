...
def train(train_file, test_file, vocabulary_size, args):
    ...
    #with tf.train.MonitoredTrainingSession(checkpoint_dir='/tmp/checkpoints') as sess:
        ...
        batch_x = data_loader(train_file,args.batch_size, args.num_epochs)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--decay_steps", type=int, default=100000, help="Decay learning rate every n steps")
